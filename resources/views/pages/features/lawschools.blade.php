  ...
  {{--   <p class="text-muted text-center"></p> --}}
    <div class="container">
        <div class="row" align="center">
            ...
            <div class="col-md-4 mb-4 ">
                <a href="{{route('lawschools.profile_management')}}" class="feature-link" >
                    <div class="card feature-div">
                        <div class="card-header bg-white border-0">
                            <div class="feature-circle-images">
            ...
            <div class="col-md-4 mb-4 ">
                <a href="{{route('lawschools.student_management')}}" class="feature-link" >
                    <div class="card feature-div">
                        <div class="card-header bg-white border-0">
                            <div class="feature-circle-images">
            ...
            <div class="col-md-4 mb-4 ">
                <a href="{{route('lawschools.team_management')}}" class="feature-link" >
                    <div class="card feature-div">
                        <div class="card-header bg-white border-0">
                            <div class="feature-circle-images">
            ...
            <div class="col-md-4 mb-4 ">
                <a href="{{route('lawschools.agenda_management')}}" class="feature-link" >
                    <div class="card feature-div">
                        <div class="card-header bg-white border-0">
                            <div class="feature-circle-images">
